        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourierUserId = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Missions_AspNetUsers_CourierUserId",
                        column: x => x.CourierUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Missions_AspNetUsers_CreatorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MissionRequests_AspNetUsers_CourierId",
                        column: x => x.CourierId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MissionRequests_Missions_MissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionRequests_CourierId",
                table: "MissionRequests",
                column: "CourierId");

            migrationBuilder.CreateIndex(
                name: "IX_MissionRequests_MissionId",
                table: "MissionRequests",
                column: "MissionId");

            migrationBuilder.CreateIndex(
                name: "IX_Missions_CourierUserId",
                table: "Missions",
